...
public class FTPDownloadFileDemo
{
  ...
  long flsize;
  long flsize2;
  private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(FTPDownloadFileDemo.class.getName());
  ...
  public void process()
  {
    try
    {
      ...
      for (FTPFile file : files)
      {
        ...
        {
          java.util.logging.Logger.getLogger(FTPDownloadFileDemo.class.getName()).log(Level.SEVERE, null, ex);
        }
  ...
  {
    FTPDownloadFileDemo ftp2 = new FTPDownloadFileDemo();
    try
    {
      for (;;)
      {
